...
for news in all_news:
    ...
    news_author.append(news.find('span',{'class':'author'}).text.strip())#Author
    ...
    news_keyword.append(news_headlines_1[max_occurance.index(max(max_occurance))])# News Keyword
    


data = [news_headlines,news_author,news_body,news_url,news_images,news_keyword]
